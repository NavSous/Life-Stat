        ...
        return (
            <div className="container mx-auto px-4 py-8">
              ...
              <section className="mb-8">
                ...
                <p className="text-lg mb-4">
                  Turn your life into an exciting game! Set goals, accomplish achievements, and watch your progress unfold across all areas of your life. LifeStat makes personal growth engaging and rewarding.
                </p>
              </section>
